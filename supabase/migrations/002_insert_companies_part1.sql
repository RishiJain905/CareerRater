...
-- This bypasses RLS policies by running as the database admin
...
-- Due to character limit, I'll create this in parts. Let me know if this first batch works!
-- Then I'll provide the remaining 90 companies in follow-up SQL files.
